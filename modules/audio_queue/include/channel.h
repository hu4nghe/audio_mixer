...
struct channel_layout
{
     ...
     *
     * @param name  the channel layout name. Available names :Mono, Stereo, 5.1, 7.1.
     *
     */
    channel_layout(std::string_view name);

    // Comparaison
    constexpr bool operator==(channel_layout rhs) const
    {
        return m_value == rhs.m_value;
    }
    constexpr bool operator==(value rhs) const
    {
        return m_value == rhs;
    }
    constexpr bool operator!=(channel_layout rhs) const
